...
DECLARE @proCentOtLeadTimeZaSofia Real, @maxKachestvoZaRazpredelenie INT, @dniObespechenieZaObekt Real, @daysSendThreshold Real;
DECLARE @qualityThreshold Real;
SET @proCentOtLeadTimeZaSofia = 0.25;
SET @dniObespechenieZaObekt = 10;
SET @daysSendThreshold = 3;
SET @qualityThreshold = 6000;
SET @maxKachestvoZaRazpredelenie = 12000;
SELECT Active.GroupSMCKod AS SMCKod, 
	   ...
	   ROUND(QualityData.SofiaPC * @daysSendThreshold * ISNULL(QualityData.AnnualKol,0)/(52*5),0) AS 'Stoka Prag Za Premestvane',
	   ...
	   VarnaToSofia = dbo.sgCalcReturnMove(2,ISNULL(ObrabotkaM.ObrabotkaMin,0),ISNULL(QualityData.Quality,99999),
						...
						ROUND(QualityData.SofiaPC * @daysSendThreshold * ISNULL(QualityData.AnnualKol,0)/(52*5),0),
						...
						1000000),
	   RuseToSofia = dbo.sgCalcReturnMove(3,ISNULL(ObrabotkaM.ObrabotkaMin,0),ISNULL(QualityData.Quality,99999),
						ROUND(QualityData.SofiaPC * dbo.sgMax(Active.LeadTimeInMonths,0.5,0) * @proCentOtLeadTimeZaSofia * ISNULL(QualityData.AnnualKol,0)/12,0),
						ROUND((1-QualityData.SofiaPC) * @dniObespechenieZaObekt * ISNULL(QualityData.AnnualKol,0)/(52*5),0),
						ROUND(QualityData.SofiaPC * @daysSendThreshold * ISNULL(QualityData.AnnualKol,0)/(52*5),0),
						ISNULL(QualityData.MaxFaktKol,0),
						...
						ISNULL(ByalaInv.ByalaInv,0),
						1000000),
	    VTToSofia = dbo.sgCalcReturnMove(4,ISNULL(ObrabotkaM.ObrabotkaMin,0),ISNULL(QualityData.Quality,99999),
						ROUND(QualityData.SofiaPC * dbo.sgMax(Active.LeadTimeInMonths,0.5,0) * @proCentOtLeadTimeZaSofia * ISNULL(QualityData.AnnualKol,0)/12,0),
						ROUND((1-QualityData.SofiaPC) * @dniObespechenieZaObekt * ISNULL(QualityData.AnnualKol,0)/(52*5),0),
						ROUND(QualityData.SofiaPC * @daysSendThreshold * ISNULL(QualityData.AnnualKol,0)/(52*5),0),
						ISNULL(QualityData.MaxFaktKol,0),
						...
						ISNULL(ByalaInv.ByalaInv,0),
						1000000),
	   ByalaToSofia = dbo.sgCalcReturnMove(5,ISNULL(ObrabotkaM.ObrabotkaMin,0),ISNULL(QualityData.Quality,99999),
						ROUND(QualityData.SofiaPC * dbo.sgMax(Active.LeadTimeInMonths,0.5,0) * @proCentOtLeadTimeZaSofia * ISNULL(QualityData.AnnualKol,0)/12,0),
						ROUND((1-QualityData.SofiaPC) * @dniObespechenieZaObekt * ISNULL(QualityData.AnnualKol,0)/(52*5),0),
						ROUND(QualityData.SofiaPC * @daysSendThreshold * ISNULL(QualityData.AnnualKol,0)/(52*5),0),
						ISNULL(QualityData.MaxFaktKol,0),
...
WHERE Quality < @maxKachestvoZaRazpredelenie AND ISNULL(MezhdinenM.MezhdinenMax,999999) > 0
ORDER BY Quality
