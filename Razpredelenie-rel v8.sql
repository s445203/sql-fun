 ...
 *
 * Release History:
 * VERSION 8:  25.10.2014 Sending low quality excess to obekti - not yet approved
...
SELECT Active.GroupSMCKod AS SMCKod, 
	   ...
	   SofiaToVarna = dbo.sgCalcMovePriority(2,ISNULL(ObrabotkaM.ObrabotkaMin,0),ISNULL(QualityData.Quality,99999),
						...
						1000000),
	   SofiaToRuse = dbo.sgCalcMovePriority(3,ISNULL(ObrabotkaM.ObrabotkaMin,0),ISNULL(QualityData.Quality,99999),
						ROUND((1-QualityData.SofiaPC) * @dniObespechenieZaObekt * ISNULL(QualityData.AnnualKol,0)/(52*5),0),
						ROUND(QualityData.SofiaPC * dbo.sgMax(Active.LeadTimeInMonths,0.5,0) * @proCentOtLeadTimeZaSofia * ISNULL(QualityData.AnnualKol,0)/12,0),
						ISNULL(QualityData.MaxFaktKol,0),
						@qualityThreshold,
						...
						ISNULL(ByalaInv.ByalaInv,0),
						1000000),
	    SofiaToVT = dbo.sgCalcMovePriority(4,ISNULL(ObrabotkaM.ObrabotkaMin,0),ISNULL(QualityData.Quality,99999),
						ROUND((1-QualityData.SofiaPC) * @dniObespechenieZaObekt * ISNULL(QualityData.AnnualKol,0)/(52*5),0),
						ROUND(QualityData.SofiaPC * dbo.sgMax(Active.LeadTimeInMonths,0.5,0) * @proCentOtLeadTimeZaSofia * ISNULL(QualityData.AnnualKol,0)/12,0),
						ISNULL(QualityData.MaxFaktKol,0),
						@qualityThreshold,
						...
						ISNULL(ByalaInv.ByalaInv,0),
						1000000),
	   SofiaToByala = dbo.sgCalcMovePriority(5,ISNULL(ObrabotkaM.ObrabotkaMin,0),ISNULL(QualityData.Quality,99999),
						ROUND((1-QualityData.SofiaPC) * @dniObespechenieZaObekt * ISNULL(QualityData.AnnualKol,0)/(52*5),0),
						ROUND(QualityData.SofiaPC * dbo.sgMax(Active.LeadTimeInMonths,0.5,0) * @proCentOtLeadTimeZaSofia * ISNULL(QualityData.AnnualKol,0)/12,0),
						ISNULL(QualityData.MaxFaktKol,0),
						@qualityThreshold,
